...
const BlogSection = () => {
    return (
        <div className="mt-32 text-center space-y-7">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-5 lg:p-0 p-5">
                <div className="card lg:w-96 hover:bg-green-500 hover:text-white border transition ease-in delay-150 hover:-translate-y-1 hover:scale-100 ">
